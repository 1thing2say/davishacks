...
{
  AppULTRASONIC.DeviceDriverSet_ULTRASONIC_Get((uint16_t *)&UltrasoundData_cm /*out*/); //Ultrasonic data
  UltrasoundDetectionStatus = function_xxx(UltrasoundData_cm, 0, ObstacleDetection);
...
void ApplicationFunctionSet::ApplicationFunctionSet_SerialPortDataAnalysis(void)
{
  ...
  if (BT_Serial.available() > 0)
  {
    ...
    {
      // while (BT_Serial.available() == 0)//Forcibly wait for a frame of data to be received
      //   ;
      c = BT_Serial.read();
...
/* WiFi rocker-style drive command — mirrors N=102 from the JSON parser.
   rocker_dir: 1=Fwd 2=Back 3=Left 4=Right 5=FwdLeft 6=BackLeft 7=FwdRight 8=BackRight 9=Stop */
void ApplicationFunctionSet::ApplicationFunctionSet_WiFiCommand(uint8_t rocker_dir, uint8_t speed)
{
  Application_SmartRobotCarxxx0.Functional_Mode = Rocker_mode;
  Rocker_CarSpeed = speed;
  switch (rocker_dir)
  {
  case 1: Application_SmartRobotCarxxx0.Motion_Control = Forward; break;
  case 2: Application_SmartRobotCarxxx0.Motion_Control = Backward; break;
  case 3: Application_SmartRobotCarxxx0.Motion_Control = Left; break;
  case 4: Application_SmartRobotCarxxx0.Motion_Control = Right; break;
  case 5: Application_SmartRobotCarxxx0.Motion_Control = LeftForward; break;
  case 6: Application_SmartRobotCarxxx0.Motion_Control = LeftBackward; break;
  case 7: Application_SmartRobotCarxxx0.Motion_Control = RightForward; break;
  case 8: Application_SmartRobotCarxxx0.Motion_Control = RightBackward; break;
  case 9:
    Application_SmartRobotCarxxx0.Motion_Control = stop_it;
    Application_SmartRobotCarxxx0.Functional_Mode = Standby_mode;
    break;
